...
class _ApiService implements ApiService {
  ...
  @override
  Future<BrandResponseBody> brands(BrandRequestBody brandRequestBody) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(brandRequestBody.toJson());
    final _options = _setStreamType<BrandResponseBody>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BrandResponseBody _value;
    try {
      _value = BrandResponseBody.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
